...
const OverviewDraft_Outline = ({name, paid_stt, stt}) => {
  const navigate = useNavigate()

  return (
    <div className='flex h-[60px] border-t items-center' onClick={() => navigate('/story/write')}>
...
export default OverviewDraft_Outline